...
| Worked with planning, QA and development | Turning an operational question into measurable checks | [Exact-day metric specification](user_retention.md) | Defined the checks and the work I handled, while final review and decisions were owned by other teams. |
